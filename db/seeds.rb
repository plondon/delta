...
Answer.create(:user => nate, question: Question.find_by_query("How do I make a map loop in Javascript?"), original_solution: "http://i.imgur.com/os9ilsl.png", final_solution: "http://i.imgur.com/LIaj4MY.png", delta: "http://i.imgur.com/tafY7oc.gif", votes: 12)
